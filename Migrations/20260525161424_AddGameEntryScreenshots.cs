...
{
    /// <inheritdoc />
    public partial class AddGameEntryScreenshots : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                name: "GameEntryScreenshots",
                columns: table => new
                {
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_GameEntryScreenshots", x => x.Id);
                    table.ForeignKey(
                        name: "FK_GameEntryScreenshots_GameEntries_GameEntryId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_GameEntryScreenshots_GameEntryId",
                table: "GameEntryScreenshots",
                column: "GameEntryId");
        }
