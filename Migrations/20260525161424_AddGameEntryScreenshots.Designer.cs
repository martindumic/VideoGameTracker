...
namespace VideoGameTracker.Migrations
{
    ...
    [Migration("20260525161424_AddGameEntryScreenshots")]
    partial class AddGameEntryScreenshots
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("VideoGameTracker.Models.AppUser", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("VideoGameTracker.Models.GameEntryScreenshot", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
                    ...
                    b.ToTable("GameEntryScreenshots");
                });
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("VideoGameTracker.Models.AppUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("VideoGameTracker.Models.GameEntry", b =>
                {
                    ...
                    b.HasOne("VideoGameTracker.Models.AppUser", "User")
                        .WithMany("GameEntries")
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
            ...
            modelBuilder.Entity("VideoGameTracker.Models.GameEntryScreenshot", b =>
                {
                    b.HasOne("VideoGameTracker.Models.GameEntry", "GameEntry")
